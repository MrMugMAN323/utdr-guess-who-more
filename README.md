...
[Play the game online now](https://mrmugman323.github.io/utdr-guess-who-more/) or [download it from the project releases](https://github.com/wearsnomask/utdr-guess-who/releases/latest) (you can also download previous versions of it here if you'd prefer). Note that the downloaded version will likely trigger a security warning about installing an untrusted program on your system; you can always just play the online version if you want to be safe.
